...
export const NavBar: FC<INavBarProps> = (props) => {
    return (
        <div className="flex justify-between items-center px-6 sm:px-4 container max-w-screen-xl mx-auto h-16 border-b border-slate-200 sticky top-0 bg-white/70 backdrop-blur-md backdrop-saturate-200 z-50">
            <div>
